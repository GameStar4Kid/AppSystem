...
- (void)start
{
    ...
    //文件地址
    NSString *urlAsString = @"http://gamestar4kid.xyz/testSpeed.tmp";
...
- (void) connection:(NSURLConnection *)connection didReceiveData:(NSData *)data
{
    ...
    {
        speedLab.text = [NSString stringWithFormat:@"%.1fM/s",speed/1048576];
    ...
    if( speed/1024>=1.0)
    {
        speedLab.text = [NSString stringWithFormat:@"%.1fK/s",speed/1024];
