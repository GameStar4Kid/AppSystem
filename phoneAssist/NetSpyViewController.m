...
- (void)viewDidLoad {
    ...
    {
        _resultLab.text = @"Not Connect to Wifi";
        return;
    }
...
-(void)refreshTableView
{
    ...
    //
    _resultLab.text = [NSString stringWithFormat:@"Total found %ld devices connected to WIFI",deviceArray.count];
